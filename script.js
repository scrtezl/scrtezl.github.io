...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var birthday = new Date("2025-1-11"); // Doğum gününü buraya girin (yıl-ay-gün)
    ...
    function updateCountdown() {
      ...
      if (distance < 0) {
        countdownElement.innerHTML = "Doğum günün kutlu olsun!";
      } else {
        ...
        countdownElement.innerHTML = days + " gün " + hours + " saat " + minutes + " dakika " + seconds + " saniye kaldı";
      }
    }
  
    updateCountdown(); // Sayfa yüklendiğinde sayacı güncelle
    setInterval(updateCountdown, 1000); // Her saniyede bir sayacı güncelle
  });
